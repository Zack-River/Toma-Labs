...
export function ShopPage() {
  ...
  return <div className="shop-shell route-page">
    ...
    <main id="main-content">
      ...
      <section className="shop-offers-section" id="offers"><div className="shop-wrap"><div className="shop-offer-main"><p className="shop-eyebrow">A little more to take home</p><h2>Choose your next<br /><em>three cups.</em></h2><p>Discovery Three brings three distinct TOMA directions together, so the next favourite can find you.</p><Link className="button button-brass" to="#bundles">See the bundles <span aria-hidden="true">↘</span></Link><div className="shop-offer-list">{SHOP_OFFERS.map((offer) => <article key={offer.label}><strong>{offer.label}</strong><span>{offer.detail}</span></article>)}</div></div><div className="shop-offer-side"><span className="offer-mark">TOMA<br /><small>OFFER / 01</small></span><p>Save when your coffee moments travel together.</p><strong>Up to 10%<br />in bundle value</strong></div></div></section>
      ...
      <section className="shop-contact-section" id="contact"><div className="shop-wrap shop-contact-inner"><div><p className="shop-eyebrow">Need a second opinion?</p><h2>Ask TOMA<br /><em>which cup fits.</em></h2></div><p>Tell us what you usually drink, how you brew it, and what you want to feel next. We’ll point you to a starting place.</p><a className="shop-whatsapp-button" href="https://wa.me/201553677070?text=Hi%20TOMA%2C%20help%20me%20choose%20my%20next%20coffee." target="_blank" rel="noreferrer" aria-label="Chat with TOMA on WhatsApp">Chat on WhatsApp <span aria-hidden="true">↗</span></a></div></section>
    </main>
    <a className="whatsapp-cta" href="https://wa.me/201553677070?text=Hi%20TOMA%2C%20help%20me%20choose%20my%20next%20coffee." target="_blank" rel="noreferrer" aria-label="Chat with TOMA on WhatsApp"><span className="whatsapp-icon" aria-hidden="true">◔</span><span>Talk to TOMA</span></a>
    <StoreFooter />
  </div>;
}
