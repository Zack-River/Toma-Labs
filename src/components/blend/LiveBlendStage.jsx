...
export function LiveBlendStage({ draft, labels }) {
  ...
  return <section className="live-stage" aria-labelledby="stage-title">
    ...
    <div className="stage-scene">
      <div className="tray" aria-hidden="true"><div className="bag"><img src="/assets/toma-bean-mark-128.png" alt="" /><strong>toma</strong><span>BLEND LAB</span><small>{stageLabel.toUpperCase()}</small></div></div>
    ...
    <div className="stage-caption"><div><p className="eyebrow">Your live recipe</p><h2 id="stage-title">{blendName}</h2><p>{caption}</p></div><TomaIcon icon={faArrowDown} className="stage-arrow" /></div>
  </section>;
}
