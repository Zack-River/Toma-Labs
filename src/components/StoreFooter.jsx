  ...
  return <footer className="toma-footer">
    <div className="toma-footer-inner">
      ...
      <div className="toma-footer-contact">
        ...
        <a href="https://wa.me/201553677070?text=Hi%20TOMA%2C%20I%20have%20a%20question%20about%20my%20coffee." target="_blank" rel="noreferrer">WhatsApp ↗</a>
      </div>
    </div>
    <div className="toma-footer-bottom">
      <span>TOMA / Coffee built with experience</span>
      <span>© TOMA Coffee</span>
      <a href="https://www.instagram.com/tomacofee/" target="_blank" rel="noreferrer">Instagram ↗</a>
    </div>
  </footer>;
}
